...
class NewsSearchAgent:
    ...
    async def invoke_news_search_agent_via_a2a(
        self, user_message: str, tool_context: ToolContext
    ):
        """
        A helpful agent help search latest news or Price (and values is calculated from price or price changes ...) related to specific company or market information

        Args:
            user_message: A question related to news
        """
        ...
        try:
            ...
            task_updater.update_status(
                ...
                message=task_updater.new_agent_message(
                    [Part(TextPart(text='Waiting for news agent to greet you back...'))]
                ),
            )
        except Exception as e:
