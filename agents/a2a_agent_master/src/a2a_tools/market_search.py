...
class MarketSearchAgent:
    ...
    async def invoke_market_search_agent_via_a2a(
        self, user_message: str, tool_context: ToolContext
    ):
        """
        A helpful market search assistant help delegate tasks to other agents.
        For searching related to detailed infomation like current stock prices, news on finance, economics about companies.

        Args:
            user_message: A question related to company or searching detailed infomation for current stock prices, news on finance, economics about companies
        """
