...
class SQLAgentCompany:
    def __init__(self, agent_url: str):
        self.agent_url = agent_url

    async def invoke_company_sql_agent_via_a2a(
        self, user_message: str, tool_context: ToolContext
    ):
        """
        For searching relevant data of company like overview, events, officers, shareholders,... in PostgreSQL by using SQL formula

        Args:
            user_message: A question related to company or searching infomation about company
        """
