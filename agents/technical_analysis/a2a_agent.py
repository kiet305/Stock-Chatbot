...
def get_a2a_routes(fqdn: str):
    ...
    skill = AgentSkill(
        id="ticker_suggestion",
        name="Ticker Suggestion Tool",
        description="Provides tickers that can be bought or sold at the moment based on SMA cross indicator",
        tags=["suggestion", "which ticker","should buy","should sell","advice","invest","potential","SMA cross indicator"],
        examples=["Can you suggest which tickers should I buy?", "At the moment, which ticker is potential to invest?"],
    )

    # A2A Agent Card definition
    agent_card = AgentCard(
        name="technical_analysis_master",
        description="Provide technical analysis of stocks using various tools and indicators OR provide potential ticker to be bought using SMA cross indicator",
        url=fqdn,
        version="1.0.0",
